...
function return_mapping(τII, P, ε̇II, Dkk, P0, ηvep, β, sp, C, Δt, comp, pl::VonMises, phases)
...
function return_mapping(τII, P, ε̇II, Dkk, P0, ηvep, β, sp, C, Δt, comp, pl::DruckerPrager, phases)
    C = if pl.soft[phases]==1.0
        # sp*pl.C[phases]
        sp*C
    else
...
function return_mapping(τII, P, ε̇II, Dkk, P0, ηvep, β, sp, C, Δt, comp, pl::DruckerPrager1, phases)
...
function return_mapping(τII, P, ε̇II, Dkk, P0, ηvep, β, sp, C, Δt, comp, pl::DruckerHyperbolic, phases)
...
function return_mapping(τII, P, ε̇II, Dkk, P0, ηvep, β, sp, C, Δt, comp, pl::Golchin2021, phases)
    Pt = -pl.σT[phases]
...
function return_mapping(τII, P, ε̇II, Dkk, P0, ηvep, β, sp, C, Δt, comp, pl::Kiss2023, phases)
...
function return_mapping(τII, P, ε̇II, Dkk, P0, ηvep, β, sp, C, Δt, comp, pl::Tensile, phases)
...
function LocalRheology(ε̇, Dkk, P0, sp, C, materials, phase_ratios, Δ)
    ...
    for phases = 1:nphases
        ...
        τII, P, λ̇ = return_mapping(τII, P, ε̇II, Dkk, P0, ηvep, β, sp, C, Δ.t, comp, materials.plasticity, phases)
...
function StressVector!(ε̇::SVector{N,T}, ε̇kk, P0, sp, C, materials, phase_ratios, Δ) where {N,T}
    η, λ̇, P, τII = LocalRheology(ε̇, ε̇kk, P0, sp, C, materials, phase_ratios, Δ)
    τ = @SVector([2 * η * ε̇[1],
        2 * η * ε̇[2],
        2 * η * ε̇[3],
        P])
