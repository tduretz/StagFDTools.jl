...
function two_phase_return_mapping()
    ...
    for it=1:nt
        ...
        pseudo_J = jacobian(ϵ̇->StressVector_trial(ϵ̇,  divVs, divqD, τ0, Pt0,  Pf0, Φ0, params), AutoForwardDiff(), ϵ̇) # pseudo_J because the 3 last rows are not really part of ∂τ/∂ϵ̇
